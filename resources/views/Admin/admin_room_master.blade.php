        ...
        <div class="container">
            <div class="row mb-3">
                <div class="col-md-10 mx-auto">
                    <br><br>
                    <h1 style="color: #DFB6B2">Room List</h1>
                        ...
                        <div class="card mb-3 mx-auto" style="max-width: 85%; margin-top: 20px;">
                            <div class="row g-0">
                                <div class="col-12 col-sm-4">
                                    <img src="{{ asset('AsetGambarRoom/' . $roomType->room_picture) }}" 
                                ...
                                <div class="col-12 col-sm-8">
                                    <div class="card-body">
                                        <h2 class="card-title">Package Name: <strong>{{ $roomType->name_type }}</strong></h2>
                                        <p style="margin-bottom:0;">Facility: <strong>{{ $roomType->facility }}</strong></p>
                                        <p style="margin-bottom:0;">Price: <strong>IDR {{ number_format($roomType->price, 2, ',', '.') }}</strong></p>
                                        <p style="margin-bottom:0;">Capacity: <strong>{{ $roomType->maximum_people }}</strong></p>
                                        <div class="d-flex justify-content-end align-items-end flex-column" style="margin-top: auto;">
                                            <div class="d-flex">
                                                <form action="{{ route('room_type.destroy', $roomType->id_room_type) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger me-2" style="width: 100px">Delete</button>
                                                </form>
                                                <a href="{{ route('room_type.edit', $roomType->id_room_type) }}" class="btn btn-success" style="width: 100px">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if($roomCount > 0)
                        <div class="mb-4">
                            <div class="d-flex justify-content-center">
                                <a href="{{ route('room_type.create') }}" class="btn btn-secondary shadow button-tambah-kamar">
                    ...
                    @else
                        <div class="mb-4">
                            <div class="d-flex justify-content-center">
                                <button class="btn btn-secondary shadow button-tambah-kamar" disabled style="background-color: grey">
                                    <strong>+ Add Room</strong>
                                </button>
                            </div>
                        </div>
