    ...
    <main>
        <div class="container mt-5">
            <div class="form-container">
                ...
                <h1 class="mb-4" style="color: #4a2d56;"><strong>Edit Room</strong></h1>

                <form action="{{ route('room_type.update', $room_type->id_room_type) }}" novalidate method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            ...
                            value="{{ old('name_type', $room_type->name_type) }}"
                        >
                        @error('name_type')
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            ...
                            value="{{ old('maximum_people', $room_type->maximum_people) }}"
                        >
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            ...
                            value="{{ old('number_of_room', $room_type->number_of_room) }}"
                        >
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <option value="" disabled {{ old('bed_type', $facilities) ? '' : 'selected' }}>Select Bed Type</option>
                                <!-- <option value="" disabled selected>Select Bed Type</option> -->
                                <option value="Single" {{ old('bed_type', $facilities) === 'Single Bed' ? 'selected' : '' }}>Single</option>
                                <option value="Double" {{ old('bed_type' ,$facilities) === 'Twin Bed' ? 'selected' : '' }}>Double</option>
                                <option value="Queen" {{ old('bed_type', $facilities) === 'Queen Bed' ? 'selected' : '' }}>Queen</option>
                            </select>
                            @error('bed_type')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('bathroom_type') is-invalid @enderror" id="bathroom_type" name="bathroom_type">
                                <option value="" disabled {{ old('bathroom_type', $facilities) ? '' : 'selected' }}>Select Bathroom Type</option>
                                <option value="Shower" {{ old('bathroom_type', $facilities) === 'Shower' ? 'selected' : '' }}>Shower</option>
                                <option value="Bathtub" {{ old('bathroom_type', $facilities) === 'Bathtub' ? 'selected' : '' }}>Bathtub</option>
                            </select>
                            @error('bathroom_type')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    name="consumption[]" 
                                    value="Breakfast"
                                    {{ is_array(old('consumption', $facilities)) && in_array('Breakfast', old('consumption', $facilities)) ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    name="consumption[]" 
                                    value="Lunch"
                                    {{ is_array(old('consumption', $facilities)) && in_array('Lunch', old('consumption', $facilities)) ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    name="consumption[]" 
                                    value="Dinner"
                                    {{ is_array(old('consumption', $facilities)) && in_array('Dinner', old('consumption', $facilities)) ? 'checked' : '' }}
                                >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    id="included" 
                                    value="Included"
                                    {{ old('heater', $heater) === 'Included' ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    id="notIncluded" 
                                    value="Not Included"
                                    {{ old('heater', $heater) === 'Not Included' ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    id="Yes" 
                                    value="Yes"
                                    {{ old('smoking', $smoking) === 'Yes' ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    id="No" 
                                    value="No"
                                    {{ old('smoking', $smoking) === 'No' ? 'checked' : '' }}
                                >
                    ...
                    >{{ old('description', $room_type->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            <img src="{{ asset('AsetGambarRoom/' . $room_type->room_picture) }}" alt="Current Picture" style="width: 150px; margin-bottom: 10px;">
                        </div>
